...
const AdminRolesPermissionsPage: React.FC<PageProps> = (props) => {
    // Tabs: 'roles' | 'users'
                                ...
                                <div className="space-y-1">
                                    ...
                                    {selectedRole.is_admin_star && (
                                        <p className="text-sm text-amber-600 dark:text-amber-400">
                                            Rol admin: solo lectura (ya posee
                                            todos los permisos).
                                        </p>
                                    )}
                                    {RoleLegend}
                        ...
                        <div className="ml-auto flex items-center gap-2 rounded border bg-neutral-100 px-2 py-1 text-xs dark:border-neutral-700 dark:bg-neutral-800">
                            ...
                            <TooltipProvider delayDuration={100}>
                                <Tooltip>
                                    ...
                                    >
                                        <p>
                                            <strong>Adjuntar</strong>: agrega
                                            los roles elegidos a cada usuario
                                            sin quitar los que ya tiene.
                                        </p>
                                    </TooltipContent>
                                </Tooltip>
                            </TooltipProvider>
                                ...
                                <Tooltip>
                                    ...
                                    >
                                        <p>
                                            ...
                                            reemplaza todos los roles de cada
                                            usuario por el conjunto seleccionado
