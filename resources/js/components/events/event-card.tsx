...
export const EventCard: React.FC<EventCardProps> = ({
    ...
    return (
        <article
            className={
                'group relative flex flex-col rounded-xl border border-neutral-200 bg-white p-4 shadow-sm transition hover:shadow-md dark:border-neutral-800 dark:bg-neutral-900 ' +
                className
            }
        >
            <div className="mb-2 flex items-center justify-between gap-2">
                <span className="inline-flex items-center rounded-full border border-fuchsia-300/60 bg-fuchsia-50 px-2 py-0.5 text-xs font-medium tracking-wide text-fuchsia-700 dark:border-fuchsia-600/40 dark:bg-fuchsia-900/30 dark:text-fuchsia-300">
            ...
            {showSummary && event.summary && (
                <p
                    className={
                        'mb-4 text-xs text-neutral-600 dark:text-neutral-400 ' +
                ...
                {event.capacity !== null && (
                    <div className="flex flex-col gap-1">
                        <div className="flex items-center justify-between text-xs text-neutral-500 dark:text-neutral-400">
                            <span>
                                {atCapacity ? 'Aforo completo' : 'Aforo'}
                            </span>
                            <span>
