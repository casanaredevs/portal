...
<head>
    ...
    <style>
        *, *::before, *::after {
        ...
        a.btn {
            display: inline-flex; /* antes inline-flex para permitir margin auto correcto */
            align-items: center;
            justify-content: center;
            gap: .5rem;
...
<div class="card">
    ...
    @if(($maintenance['remainingSeconds'] ?? null) !== null && ($maintenance['remainingSeconds'] ?? 0) > 0)
        <div>
            <div
                style="font-size:.65rem;letter-spacing:.08em;text-transform:uppercase;opacity:.6;margin-bottom:.25rem;">
